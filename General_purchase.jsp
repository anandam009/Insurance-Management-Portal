...
%>
                    <div class="alert alert-success" role="alert" style="margin-top: 13%;width: 37%;margin-left: 33%;">
                        <h4 class="alert-heading">Well done!</h4>
                        <p>You have purchased a General Insurance policy, so sit back and relax. You click, we cover! </p>
                        <hr>
                        <p class="mb-0"></p>
                        <a href="General_purchase.html" class="btn bg-dark mb-3" style="background-color: #007bff!important;color:#fff !important;">Buy a new policy</a>
                        <a href="WelcomeUser.jsp" class="btn bg-dark mb-3" style="background-color: #007bff!important;color:#fff !important;">Close</a>
