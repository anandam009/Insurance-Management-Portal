...
%>
                    <div class="alert alert-warning" role="alert" style="margin-top: 13%;width: 37%;margin-left: 33%;">
                        <h4 class="alert-heading">Well done!</h4>
                        <p>You have purchased a Health Insurance policy, so sit back and relax. You click, we cover! </p>
                        <hr>
                        <p class="mb-0"></p>
                        <a href="Health_purchase.html" class="btn bg-dark mb-3" style="background-color: #8BC34A!important;color:#fff !important;">Buy a new policy</a>
                        <a href="WelcomeUser.jsp" class="btn bg-dark mb-3" style="background-color: #8BC34A!important;color:#fff !important;">Close</a>
