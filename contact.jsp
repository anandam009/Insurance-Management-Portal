...
ResultSet rs; 
int i=st.executeUpdate("insert into contact_us(cname,caddress,cemail,cphone,comment) values ('"+cname+"','"+caddress+"','"+cemail+"','"+cphone+"','"+comment+"')"); 
%>
